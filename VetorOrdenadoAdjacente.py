class VetorOrdenadoAdjacente:
    ...
    def inserir(self, adjacentes):
        if self.numeroElementos == 0:
            self.adjacentes[0] = adjacentes
        ...
        while i < self.numeroElementos:
            if adjacentes.distanciaAEstrela > self.adjacentes[posicao].distanciaAEstrela:
                posicao += 1
            i += 1
        ...
        self.adjacentes[posicao] = adjacentes
        self.numeroElementos += 1
